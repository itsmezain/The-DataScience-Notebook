...
app.layout = html.Div([
    html.Div(children=[
        html.H2('My First Dashboard', style={'color': 'red', 'text-align' : 'center'} )
        ],style={'border': '1px black solid', 'float': 'left', 'width' : '100%', 'height': '50px'}),
    
    html.Div(children= [
        dcc.Graph(id='scatter-plot',
                  figure={'data': [go.Scatter(x= data['population_total'],
    ...
    html.Div(children= [
        dcc.Graph(id='Box Plot',
                  figure= {'data':[go.Box(x=data['gdp_total_yearly_growth'])],
